...
{
int numtasks, rank, dest, tag, source, rc, count; //int numtasks, rank, dest, tag, source, rc, count;
char inmsg, outmsg='x'; //char inmsg, outmsg='x';
